    ...
    <div className="space-y-16">
      ...
      <div>
        ...
        <p className="mt-4 max-w-lg text-lg leading-relaxed text-muted-foreground">
          Every component, every variant, every state&mdash;the living reference
          for the design&#8209;to&#8209;deploy system.
        </p>
      </div>
          ...
          <Card>
            ...
            <CardContent>
              <p className="text-sm text-muted-foreground">
                Typed tokens, themed components, and comprehensive testing
                infrastructure.
              </p>
            </CardContent>
        ...
        <Dialog open={dialogOpen} onOpenChange={setDialogOpen}>
          ...
          <DialogContent>
            <DialogHeader>
              ...
              <DialogDescription>
                This dialog demonstrates the overlay backdrop, content panel,
                close button, and footer action layout.
              </DialogDescription>
            </DialogHeader>
            <DialogFooter>
              <Button
